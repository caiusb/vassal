/*
 * $Id: MappedDataBufferInt.java 5020 2009-02-01 18:41:24Z uckelman $
 *
...
public class MappedDataBufferInt extends DataBuffer {
   ...
   */
  public MappedDataBufferInt(int size, int bankNum) throws IOException {
    ...
    try { 
      buf = raf.getChannel()
               .map(FileChannel.MapMode.READ_WRITE, 0, 4*bankSize*bankNum)
               .asIntBuffer();
    }
    finally {
      raf.close();
  ...
  public int getElem(int bank, int i) {
    ...
    return buf.get(bank*bankSize+i);
  }
